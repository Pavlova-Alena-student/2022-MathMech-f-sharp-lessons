...
let productName = "2022MathMechFSharpLessons"
let sln = __SOURCE_DIRECTORY__ </> ".." </> "2022MathMechFSharpLessons.sln"
...
let gitOwner = "Pavlova-Alena-student"
let gitRepoName = "2022MathMechFSharpLessons"
