...
#### Task5 module
Домашка 5. 
1. Используя представления матрицы и вектора из предыдущей домашки, реализовать над ними необходимые для реализации обхода в ширину операции (маску, поэлементные операции с вектором). Маской может быть любой вектор. Поэлементная операция может быть любой. 
2. Реализовать алгоритм обхода в ширину, используя матрично-векторные операции. Не забыть про то, что алгоритм обхода в ширину —- это алгоритм обхода графа, а не просто набор операций над матрицами и векторами. `Task5.BFS`
