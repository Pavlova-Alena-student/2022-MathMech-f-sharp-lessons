...
1. Реализовать сортировку пузырьком: функция принимает список и возвращает отсортированный список. Добавить необходимые тесты. `MyFuncBubbleSort` и `MyOOPBubbleSort`
2. Реализовать сортировку Хоара (быструю сотрировку): функция принимает список и возвращает отсортированный список. Добавить необходимые тесты. `MyFuncQuickSort` и `MyOOPQuickSort`
3. Реализовать конкатенацию двух списков: функуия принимает два списка и возвращает третий —- конкатенацию двух входных. `MyFuncConCat` и `MyOOPConCat`
